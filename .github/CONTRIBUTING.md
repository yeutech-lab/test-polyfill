# Contributing to `test-polyfill`

Love test-polyfill and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/yeutech-lab/test-polyfill/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/test-polyfill.git
   # Navigate to the newly cloned directory
   cd test-polyfill
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kopax/test-polyfill.git
   ```
